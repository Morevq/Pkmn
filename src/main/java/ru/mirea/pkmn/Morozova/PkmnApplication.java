...
import ru.mirea.pkmn.Morozova.web.http.PkmnHttpClient;
import ru.mirea.pkmn.Morozova.web.jdbc.DatabaseServiceImpl;
...
public class PkmnApplication {
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException, SQLException {
        ...
        Card import_some_card = cardExport.deserialize("src/main/resources/Sigilyph.crd");
